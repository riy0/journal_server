  ...
  _createClass(UserController, [{
    ...
    value: function create(req, res, next) {
      ...
      _bcrypt2.default.hash(req.body.password, 10).then(function (hash) {
        var action = 'INSERT INTO users(username, email, password, created_at, updated_at) VALUES($1, $2, $3, $4, $5) RETURNING username, email, created_at, updated_at';
        var values = [req.body.username, req.body.email, hash, 'NOW()', 'NOW()'];
        var query = {
          text: action,
          values: values
        };
